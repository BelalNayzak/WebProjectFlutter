    ...
    return Scaffold(
      ...
      body: Scrollbar(
        ...
        child: SingleChildScrollView(
          ...
          child: Stack(
            children: [
              Image.asset('assets/images/service-details/Details.png'),
              Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            SizedBox(
                                ...
                                child: Image.asset('assets/images/service-details/arrows.png')),
                            Container(
                                ...
                                children: [
                                  SpanTextWidget(
                                      ...
                                      textsList: [
                                        ...
                                        TextSpan(
                                            text:
                                                'This involves creating visual content for various mediums such as print, digital, and social media.',
                                            style: TextStyle(
                                                color: Colors.black,
                                                fontSize:
                        ...
                        Padding(
                          padding:
                              EdgeInsets.only(top: standardSize.width * 0.1),
                          child: Row(
                            children: [
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          children: [
                                            Padding(
                                              padding: EdgeInsets.only(
                                                  left: standardSize.width *
                                                      0.045,
                                                  right: standardSize.width *
                                                      0.04),
                                              child: Text(
                                                'DOWNLOAD PDF',
                                                style: TextStyle(
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          width: standardSize.width * 0.09,
                          margin:
                              EdgeInsets.only(left: standardSize.width * 0.6),
                          child: InkWell(
                            onTap: () {},
                            child: Row(
                              children: [
                                ...
                                Image.asset('assets/images/service-details/Vectors.png',
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsets.only(
                                    top: standardSize.width * 0.045, bottom: standardSize.width * 0.04),
                                child: SpanTextWidget(
                                    textAlign: TextAlign.left,
                                    textsList: [
                                      TextSpan(
